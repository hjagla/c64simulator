...
#Region "Load File"
    Public Sub Load(Filename As String, Address As Integer)
        If System.IO.File.Exists(Filename) Then
            ...
            Next
            LogText("File Loaded " & Filename & " ROM - " & FileLen(Filename) & " bytes at Offset " & Address & " (" & Hex(Address) & ")")
        Else
            MsgBox(Filename & " - File not found", MsgBoxStyle.Critical, "Error")
        End If
    End Sub
